...
public class CourseListController {
    ...
    private String courseDetails(@PathVariable("id") Long courseId, Model model) {
    ...
    // private String getCourseListTeacher(@RequestParam("tId") Long tId, Model
    // model){
    ...
    // if(courseInfo1.getCourseName().equals(courseName) &&
    // startDate.equals(fromDate) && endDate.equals(toDate)){
    // courseList.add(courseInfo1);
    // }
    ...
    // !methodList.equals("")){
    // List<CourseInfo> courseList =
    // courseRepo.findByLevelAndCategoryAndClassType(levelList,
    // categoryList,methodList);
    // model.addAttribute("courseList", courseList);
    // model.addAttribute("classType", methodList);
    // model.addAttribute("category", categoryList);
    // model.addAttribute("level", levelList);
