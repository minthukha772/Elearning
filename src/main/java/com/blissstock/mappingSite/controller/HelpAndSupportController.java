...
public class HelpAndSupportController {
     ...
     * 
     * // return "redirect:/CM0011_EmailConfirm.html";
     * // return new RedirectView("/CM0011_EmailConfirm");
     * // return "CM0011_EmailConfirm.html";
     * 
     * // return "redirect:/email-confirmscreen";
     * return "redirect:/guest/saveInquiry/confirm";
     * 
     * } catch (Exception e) {
     * e.printStackTrace();
     * }
     ...
     * }
     * 
     * @GetMapping("/guest/saveInquiry/confirm")
