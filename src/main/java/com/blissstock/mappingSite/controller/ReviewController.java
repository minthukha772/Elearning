...
public class ReviewController {
  ...
  private String getStudentReviewForm(
    ...
    model.addAttribute(
      "postAction",
      "/update-student-review/" + courseId + "/" + userId
    );
  ...
  private String postStudentReviewForm(
    @Valid @ModelAttribute("review") StudentReviewDTO stuReviewDTO,
    @PathVariable Long courseId,
    @PathVariable Long userId,
  ...
  private String editStudentReviewForm(
  ...
  private String getTeacherReviewForm(
    @PathVariable Long courseId,
    @PathVariable Long userId,
    Model model
  ) {
    ...
    model.addAttribute(
      "postAction",
      "/update-teacher-review/" + courseId + "/" + userId
    );
    return "CM0007_WriteReviewTeacher";
  }

  @PostMapping(value = "/update-teacher-review/{courseId}/{userId}")
  private String postTeacherReviewForm(
    @Valid @ModelAttribute("review") TeacherReviewDTO trReviewDTO,
    BindingResult bindingResult,
    @PathVariable Long courseId,
    @PathVariable Long userId,
    Model model,
  ...
  private String editTeacherReviewForm(
    @PathVariable Long reviewId,
    Model model,
    final RedirectAttributes redirectAttributes
  ) {
