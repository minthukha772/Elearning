...
public class LeaveInfo {
    ...
    @Column(name = "leave_start_time", columnDefinition = "timestamp with time zone not null")
    @NotNull
    ...
    @Column(name = "leave_end_time", columnDefinition = "timestamp with time zone not null")
    @NotNull
   // @Temporal(TemporalType.TIME)
    //@Temporal(TemporalType.TIMESTAMP)
    @Temporal(TemporalType.TIMESTAMP)
