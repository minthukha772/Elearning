...
public interface UserAccountRepository
  ...
  @Query(
    value = "SELECT i.user_name,i.phone_no,u.account_status,u.mail FROM user_info i,user_account u WHERE i.user_account_account_id=u.account_id AND u.role=:role;",
    nativeQuery = true
  )
