...
public interface TestQuestionRepository extends JpaRepository<TestQuestion, Long> {
    ...
    @Query(value = "Select * from test_question where test_id = :test_id order by id asc", nativeQuery = true)
    ...
    @Query(value = "Select count(id) from test_question where question_type='FREE_ANSWER' and test_id = :test_id", nativeQuery = true)
